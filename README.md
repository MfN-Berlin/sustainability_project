...
The repository lists publications and presentations of the research project "Promoting sustainable data practices and infrastructures in biodiversity science" sponsored by the German Research Foundation (DFG) (DFG Grant No. 528674292). Staff: Mareike Petersen (PI), Giuditta Parolini (Research fellow).
...
# Licence(s)
See the individual licences of the listed items.
